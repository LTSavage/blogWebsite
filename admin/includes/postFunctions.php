...
if (isset($_GET['publish']) || isset($_GET['unpublish'])) {
	...
	if (isset($_GET['publish'])) {
        ...
        togglePublishPostOn($post_id, $message);
	} else if (isset($_GET['unpublish'])) {
		$message = "Post successfully unpublished";
		$post_id = $_GET['unpublish'];
        togglePublishPostOff($post_id, $message);
	}
	
}
// Publish 
function togglePublishPostOn($post_id, $message)
{
	global $conn;
...
// un-publish
function togglePublishPostOff($post_id, $message)
{
	global $conn;
