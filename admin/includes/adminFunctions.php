...
- - - - - - - - - - - - -*/
// Gets the User/Post/Topic numbers
function getNumbers() {
    global $conn, $topicNu, $postNu, $userNu;
    $sql="SELECT COUNT(*) FROM topics";
    $result = mysqli_query($conn,$sql);
    $topicNu = mysqli_num_rows($result);
    $sql="SELECT COUNT(*) FROM users";
    $result = mysqli_query($conn,$sql);
    $userNu = mysqli_num_rows($result);
    $sql="SELECT COUNT(*) FROM posts";
    $result = mysqli_query($conn,$sql);
    $postNu = mysqli_num_rows($result);
